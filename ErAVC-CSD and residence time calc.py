...
# CSV files must be located inside the "data" folder
FILES = {
    "Host_Plag": "data/HG13B-PLAG-Results.csv",
    "Host_Amph": "data/HG13B-AMPH-Results.csv",
    "Enclave_Plag": "data/HG13E-PLAG-Results.csv",
    "Enclave_Amph": "data/HG13E-AMPH-Results.csv"
}
...
for name, file in FILES.items():
    ...
    if len(x) < 6:
        print(f"{name}: Not enough CSD bins for regression.")
        continue
    ...
    if delta_aic > AIC_THRESHOLD and params is not None and brk is not None:
